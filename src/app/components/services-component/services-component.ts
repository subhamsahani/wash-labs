...
export class ServicesComponent {
 ...
 packages = [
    ...
    },
    {
      ...
      icon: 'pricing/express-delivery.png',
      deliveryDays: '1 Days',
      priceUnit: 'kg',
      price: 249,
      minBilling: 399,
